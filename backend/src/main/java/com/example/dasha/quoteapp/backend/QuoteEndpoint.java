...
@Api(
        ...
        namespace = @ApiNamespace(
                ownerDomain = "backend.quoteapp.dasha.example.com",
                ownerName = "backend.quoteapp.dasha.example.com",
                packagePath = ""
        )
)
public class QuoteEndpoint {
    ...
    public Quote insert(@Named("id") Long id, @Named("author") String author, @Named("text") String text) {
        ...
        Quote quote = new Quote(id, author, text);
